                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="homework-content my-2">
                                        {{ Str::words($item->session_summary, 10) }}
                                    </div>
                                    <a href="{{ route('student.session-notes.show', $item->id) }}"
                    ...
                    @empty
                        <div class="col-md-12 text-center mt-3">
                            <div class="alert alert-primary p-5">
                                <i class="bi bi-pencil-square"></i> No session notes available for this student.
                            </div>
                        </div>
                    @endforelse
                </div>
