                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="row g-3" action="{{ route('tutor.profile.update') }}" method="POST">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <form class="row g-3" action="{{ route('tutor.profile.update.password') }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                            id="pwd-confirm" name="password_confirmation" />
                                    </div>
                                    <div class="col-12">
