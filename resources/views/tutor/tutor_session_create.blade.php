                            ...
                            <form action="{{ route('tutor.sessions.generate-pre-session-plan') }}" method="POST"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" autocomplete="off"
                                                    ...
                                                    id="session_date" name="date" value="{{ old('date') }}" />
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="session_end_time" name="end_time" value="{{ old('end_time') }}" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="additional_instructions" name="additional_instructions" aria-describedby="aiHelp"></textarea>
                                    </div>
                                </div>
                                <div class="card-footer prebutton-wrapper text-end">
                                    <button type="submit" class="btn btn-primary btn-sm generate-plan">Generate Session
                                        Plan</button>
                                </div>
                            </form>
                        </div>
              ...
              `;
                    ...
                    document.querySelector('.save-schedule').addEventListener(
                        ...
                        async (event) => {
                            ...
                            finalFormData.append('lesson_outlines', JSON.stringify(data.content
                                .lesson_outline));
                            finalFormData.append('practice_questions', JSON.stringify(data.content
                                .practice_questions));
